...
async function main() {
  ...
  try {
    ...
    await page.waitForSelector(".component-spec-panel", { timeout: 15000 });
    ...
    if (result.componentSpecPanels < 1) throw new Error("Dev server did not render the component spec panel");
